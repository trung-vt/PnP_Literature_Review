...
\paragraph*{Gradient-step denoisers (a special case).}
Some works restrict the denoiser to have the form of one gradient descent step on a learned energy,
for example
$$
D(x) = x - \eta \nabla \phi_\theta(x).
$$
This makes it easier to connect PnP iterations to explicit objectives and to prove convergence
under weaker assumptions \cite{hurault2021gsd,hurault2022icml}.
...
\begin{itemize}
    ...
    Open questions include: accurate forward and noise models, sampling design, and fair evaluation
